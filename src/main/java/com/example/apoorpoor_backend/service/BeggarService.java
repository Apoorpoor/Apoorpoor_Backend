...
public class BeggarService {
    ...
    public ResponseEntity<BeggarSearchResponseDto> myBeggar(String username) {
        ...
        String topImage = beggar.getTop().getItemImage();
        String bottomImage = beggar.getBottom().getItemImage();
        String shoesImage = beggar.getShoes().getItemImage();
        String accImage = beggar.getAcc().getItemImage();
